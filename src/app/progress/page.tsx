...
const initialTasks: Task[] = [
  {
    ...
    description: "Initialize project with Next.js 16, TypeScript, and Tailwind CSS v4",
    status: "completed",
    priority: "high",
    category: "Setup",
  },
  {
    id: "2",
    title: "Setup Prisma + SQLite",
    description: "Configure Prisma ORM with SQLite database for local development",
    status: "completed",
    priority: "high",
    category: "Setup",
  },
  {
    id: "3",
    title: "Build color system & design tokens",
    description: "Extract colors from Behance screenshots and create design system",
    status: "completed",
    priority: "high",
    category: "Design",
  },
  {
    id: "4",
    title: "Build portfolio frontend pages",
    description: "Hero, project grid, project detail pages with Behance-inspired design",
    status: "completed",
    priority: "high",
    category: "Frontend",
  },
  {
    ...
    description: "Login page, project list, project CRUD, media upload",
    status: "completed",
    priority: "high",
    category: "Admin",
  },
  {
    id: "6",
    title: "Update content from CV",
    description: "Match About section, work experience, skills, and personal info with CV",
    status: "completed",
    priority: "high",
    category: "Content",
  },
  {
    id: "7",
    title: "Implement image upload to public/uploads/",
    description: "Upload cover image and gallery images to local filesystem",
    status: "completed",
    priority: "high",
    category: "Feature",
  },
  {
    id: "8",
    title: "Add GIF support + drag & drop reorder",
    description: "Support GIF uploads and drag-and-drop gallery reordering",
    status: "completed",
    priority: "medium",
    category: "Feature",
  },
  {
    ...
    description: "Prepare for Vercel deployment with PostgreSQL and Supabase Storage",
    status: "in-progress",
    priority: "high",
    category: "Deployment",
  },
  {
    ...
    description: "Update Prisma schema for PostgreSQL and test migration",
    status: "pending",
    priority: "high",
    category: "Deployment",
  },
  {
    ...
    description: "Configure Supabase bucket for image uploads in production",
    status: "pending",
    priority: "high",
    category: "Deployment",
  },
  {
    ...
    description: "Final deployment to production with all environment variables",
    status: "pending",
    priority: "high",
    category: "Deployment",
  },
  {
    id: "13",
    title: "Auto compress/resize images before upload",
  ...
  },
  {
    ...
    description: "Meta tags, Open Graph, structured data for better SEO",
    status: "pending",
    priority: "medium",
    category: "SEO",
  },
  {
    id: "15",
    title: "Add contact form email notification",
    description: "Send email notification when someone submits contact form",
    status: "pending",
    priority: "low",
    category: "Feature",
  },
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="space-y-3">
          {filteredTasks.map((task) => (
            <div
              key={task.id}
              className="bg-canvas rounded-xl border border-border p-6 hover:shadow-md transition-shadow"
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <span className="text-xs text-ink-light bg-gray-50 px-2 py-1 rounded">
                    {task.category}
                  </span>
                </div>
                <div className="flex gap-2">
                  <select
                    ...
                    className="text-sm border border-border rounded-lg px-3 py-1.5 bg-canvas focus:outline-none focus:border-accent"
                  >
