...
const initialTasks: Task[] = [
  ...
  { id: "13", title: "Auto compress/resize images before upload", description: "Optimize images to reduce file size and improve loading speed", status: "pending", priority: "low", category: "Feature" },
  { id: "14", title: "Add SEO optimization", description: "Meta tags, Open Graph, structured data for better SEO", status: "pending", priority: "medium", category: "SEO" },
  { id: "15", title: "Add contact form email notification", description: "Send email notification when someone submits contact form", status: "pending", priority: "low", category: "Feature" },
];
